...
import { ArrowRight, Briefcase, Bus, CheckCircle2, Loader2, ShieldCheck, Sparkles, User } from 'lucide-react';
        ...
        <div className="w-full max-w-[480px] bg-white dark:bg-zinc-900 rounded-[2.5rem] shadow-[0_20px_40px_-15px_rgba(0,0,0,0.1)] dark:shadow-none border border-zinc-100 dark:border-zinc-800 p-8 sm:p-10 relative z-10">
          ...
          <form onSubmit={handleRegister} className="space-y-6">
            ...
            <div className="relative flex p-1.5 bg-zinc-100 dark:bg-zinc-950 rounded-2xl border border-zinc-200/50 dark:border-zinc-800 shadow-inner">
              ...
              <div
                className={`absolute inset-y-1.5 w-[calc(50%-6px)] bg-white dark:bg-zinc-800 rounded-xl shadow-sm transition-all duration-500 ease-out ${role === 'client' ? 'left-1.5' : 'left-[calc(50%+1.5px)]'
                  }`}
              />
              ...
              <button
                ...
                className={`relative z-10 flex-1 flex items-center justify-center gap-2 py-3.5 text-sm font-bold transition-colors duration-300 rounded-xl ${role === 'client' ? 'text-zinc-900 dark:text-white' : 'text-zinc-400 hover:text-zinc-600 dark:hover:text-zinc-300'
                  }`}
              >
              ...
              <button
                ...
                className={`relative z-10 flex-1 flex items-center justify-center gap-2 py-3.5 text-sm font-bold transition-colors duration-300 rounded-xl ${role === 'operator' ? 'text-zinc-900 dark:text-white' : 'text-zinc-400 hover:text-zinc-600 dark:hover:text-zinc-300'
                  }`}
              >
